...
describe('Password-strength bar:',()=>{
    ...
    it('Should exist',()=>{
        render(<LoginForm passwordStrength={100} passwordComment='' passwordConfig={null} usernameConfig={null} onSubmit={()=>{}} passwordHandler={()=>{}}  />);
        bar = document.getElementById('password-bar');
        expect(bar).not.toBeNull();
    });
    
    it('Should be empty when called with props password-strength = 0',()=>{
        render(<LoginForm passwordStrength={0} passwordComment='' passwordConfig={null} usernameConfig={null} onSubmit={()=>{}} passwordHandler={()=>{}}  />);
        bar = document.getElementById('password-bar');
    ...
    it('Should have lenth of half, when called with props password-strength = 50',()=>{
        render(<LoginForm passwordStrength={50} passwordComment='' passwordConfig={null} usernameConfig={null} onSubmit={()=>{}} passwordHandler={()=>{}}  />);
        bar = document.getElementById('password-bar');
        expect(parseInt(bar?.style.width||"NaN")).toBe(50);
    });

    it('Should have lenth of n, when called with props password-strength = n',()=>{
        render(<LoginForm passwordStrength={30} passwordComment='' passwordConfig={null} usernameConfig={null} onSubmit={()=>{}} passwordHandler={()=>{}}  />);
        bar = document.getElementById('password-bar');
        expect(parseInt(bar?.style.width||"NaN")).toBe(30);

        render(<LoginForm passwordStrength={60} passwordComment='' passwordConfig={null} usernameConfig={null} onSubmit={()=>{}} passwordHandler={()=>{}}  />);
        bar = document.getElementById('password-bar');
